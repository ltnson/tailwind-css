const FeaturesReverse = () => {
  return (
    <div>
      ...
      <div className="grid grid-cols-2 bg-slate-200 h-[38rem] my-10">
        <div className="pl-20 py-32 relative">
          <div className="absolute right-0 bottom-32 z-10 bg-black rounded-md w-3/4 h-2/4"></div>
          <div className="absolute right-32 top-28 bg-white rounded-md w-3/4 h-2/4 mb-10"></div>
        </div>
